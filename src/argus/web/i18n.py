...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "mqtt_config_note": (
            "Configured via ARGUS_MQTT_HOST and related environment variables — see /etc/argus/agent.env. "
    ...
    "es": {
        ...
        "mqtt_config_note": (
            "Se configura con ARGUS_MQTT_HOST y variables de entorno relacionadas — ver /etc/argus/agent.env. "
    ...
    "pt": {
        ...
        "mqtt_config_note": (
            "Configurado via ARGUS_MQTT_HOST e variáveis de ambiente relacionadas — veja /etc/argus/agent.env. "
    ...
    "fr": {
        ...
        "mqtt_config_note": (
            "Configuré via ARGUS_MQTT_HOST et les variables d'environnement associées — voir /etc/argus/agent.env. "
    ...
    "de": {
        ...
        "mqtt_config_note": (
            "Konfiguriert über ARGUS_MQTT_HOST und zugehörige Umgebungsvariablen — siehe /etc/argus/agent.env. "
